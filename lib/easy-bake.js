...
(function() {
  ...
  eb.Baker = (function() {
    ...
    Baker.prototype.runTest = function(args, options) {
      var spawned,
        _this = this;
      if (options == null) {
        options = {};
    ...
    Baker.prototype.test = function(options, command_queue) {
      var file, file_group, file_groups, original_callback, owns_queue, run_tests_fn, set, set_name, set_options, tests_to_run, _i, _j, _len, _len1, _ref, _ref1,
        _this = this;
      if (options == null) {
        options = {};
      }
      ...
      for (set_name in _ref) {
        ...
        if (!set_options.runner) {
          console.log("Missing runner for tests: " + set_name);
          continue;
        }
