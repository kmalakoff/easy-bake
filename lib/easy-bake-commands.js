...
(function() {
  var ebc, fs, path, spawn, timeLog, uglifyjs, wrench, _;
  ...
  ebc.RunCoffee = (function() {
    ...
    RunCoffee.prototype.run = function(callback, options) {
      ...
      notify = function(code) {
        var output_name, _i, _len, _ref;
        _ref = _this.targetNames();
        for (_i = 0, _len = _ref.length; _i < _len; _i++) {
          output_name = _ref[_i];
          if (code === 0) {
            if (!options.silent) {
              timeLog("built " + (output_name.replace(_this.command_options.root_dir, '')));
            }
          } else {
            timeLog("failed to build " + (output_name.replace(_this.command_options.root_dir, '')) + " .... error code: " + code);
          }
        }
  ...
  ebc.RunUglifyJS = (function() {
    ...
    RunUglifyJS.prototype.run = function(callback, options) {
      ...
      try {
        ...
        if (!options.silent) {
          timeLog("minified " + (this.outputName().replace(this.command_options.root_dir, '')));
        }
        return typeof callback === "function" ? callback(0, this) : void 0;
      } catch (e) {
