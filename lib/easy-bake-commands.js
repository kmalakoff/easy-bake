...
(function() {
  ...
  eb.command.Command = (function() {
    ...
    Command.prototype.run = function(options, callback) {
      var arg, display_args, index, scoped_args, spawned, _ref,
        _this = this;
      if (options == null) {
        options = {};
      }
      ...
      for (index in _ref) {
        arg = _ref[index];
        try {
          scoped_args[index] = require.resolve(arg);
        } catch (e) {

        }
      }
      if (options.preview || options.verbose) {
        display_args = _.map(scoped_args, function(arg) {
      ...
      spawned = spawn(this.command, scoped_args, this.command_options);
