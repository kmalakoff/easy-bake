...
(function() {
  var INTERNAL_MODES, INTERNAL_SETS, MAX_MESSAGE_LENGTH, RUNNERS_ROOT, TEST_DEFAULT_TIMEOUT, coffeescript, eb, existsSync, fs, path, print, spawn, timeLog, _, _base;
  ...
  eb.Oven = (function() {
    function Oven(config, options) {
      var config_pathed_filename, error, length;
      if (options == null) {
        options = {};
      }
    ...
    Oven.prototype._validateConfig = function() {
      var mode_name, set, set_name, _ref;
    ...
    Oven.prototype.clean = function(options, callback) {
      var build_queue, command, command_queue, output_directory, pathed_build_name, pathed_targets, postinstall_queue, _i, _j, _k, _len, _len1, _len2, _ref, _ref1;
      if (options == null) {
        options = {};
      }
      command_queue = options.queue ? options.queue : new eb.command.Queue();
