...
var EasyBake, TEST_DEFAULT_TIMEOUT, Utils, fs, globber, path, print, spawn, uglifyjs, wrench, yaml, _,
...
EasyBake = (function() {
  ...
  EasyBake.prototype.minifiedOutputName = function(output_directory, source_name) {
  ...
  EasyBake.prototype.minifiedName = function(output_name) {
  ...
  EasyBake.prototype.minify = function(output_name, options, code) {
  ...
  EasyBake.prototype.runTest = function(args, options) {
    ...
    return spawned.on('exit', function(code) {
      var test_filename;
      test_filename = Utils.removeString(args[1], "file://" + _this.YAML_dir + "/");
      if (code === 0) {
        if (!options.silent) {
